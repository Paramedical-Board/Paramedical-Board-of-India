...
export async function GET() {
  ...
  const { data, error } = await supabaseAdmin
    ...
    .select(
      "id, registration_no, candidate_name, course, academic_session, roll_no, admit_card_generated_at, exam_session_id, exam_sessions(session_label, academic_session)"
    )
    .not("roll_no", "is", null)
